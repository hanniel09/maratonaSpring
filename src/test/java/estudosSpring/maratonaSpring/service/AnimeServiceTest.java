...
public class AnimeServiceTest {
    ...
    @Test
    @DisplayName("findByIdOrThrowBadRequestException returns a list of anime when successful")
    void findByIdOrThrowBadRequestException_ReturnsAnimesInsidePageObject_WhenSuccessful() {
